    ...
    <div className="app-container">
      {step === -1 && (
        <div className="welcome-screen">
          ...
          <button className="next-button" onClick={nextStep} style={{marginTop:"20px"}}>
            Start
          </button>
        </div>
      )}
      ...
      {step === 2 && (
        <div className="question-screen">
          <h2>
            It has been almost five years since we became friends 🤝. It has taken
            me two years to realize I have feelings for you 🥰. Do you have that
            one feeling for me  👉👈?
          </h2>
          <button className="next-button" onClick={nextStep}>
            Next
      ...
      {step === 4 && (
        <div className="letter-screen">
          <div className="letter">
            <p>Dear Love,</p>
            <p>
              I want to let you know that I like you more than a
              friend. We have been good friends, but you are more than a friend
              to me. I like you and want our relationship to be more than
              friendship. I have decided not to be shy about saying what I have
              been feeling for so long. I love you....🌻❤️, and I have been
              hiding it since we met. My feelings for you are not worth keeping
              inside. They need to be showcased in front of you. Let me do
              it...... 🥺 I love you Sampurna AKA Golu ( My one and only love )
              😘. Do you love me......? If your answer is yes,then visit to the next page.
              I have dedicated a poem for you written by me. If you like it, I also
              deserve a kiss 🥺 .
            </p>
      ...
      {step === 5 && (
        <div className="poem-screen">
          ...
          <p>
            ...
            শহরের ভিড়ে দেখেছি তোমার চোখ ।<br /><br />
            বিকল যত অন্ধ চিন্তা আসে <br />
            চাইছি তারা আজকে শুন্য হোক ।<br /><br />
            উড়ে যাক সব হিসেবের কালোচিঠি <br />
            এমনিও তুমি বন্যা হয়েই আসো ।<br /><br />
            না বলা কথা জড়িয়ে যায় মুখে <br />
            বোঝা যায় তুমি আমাকেই ভালোবাসো ।<br /><br />
            আসমানী যত পুরোনো তারার ভিড়ে <br />
            সাজিয়ে রাখবো তোমায় নিজের ঘরে ।<br /><br />
            তুমিও পারলে একখানা ছবি রেখো
            <br />
            যাতে যখন তখন আমায় মনে পরে ।<br /><br />
            চলো আবার দুজন সাদামাটা প্রেম করি
            <br />
            বেশিকিছু আমি চাইনা তোমার থেকে ।<br /><br />
            তোমার ভীষণ ব্যস্ত সময় ঘড়ির জালে <br />
            আমাকে তুমি এক কোণে দিও রেখে ।<br /><br />
            রাখবনা আমি মাঝখানে আর কিছু <br />
            মন মানেনা আমার তোমাকে ছাড়া ।<br /><br />
